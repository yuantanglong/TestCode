...
public class MyClassicsHeader extends RelativeLayout implements RefreshHeader {
    ...
    public int onFinish(RefreshLayout layout, boolean success) {
        ...
        if (success) {
            ...
            setLastUpdateTime(new Date());
//            UIUtils.setStatusTextColor(false, mActivity);
        } else {
...
//                    UIUtils.setStatusTextColor(true, mActivity);
//                    EventBus.getDefault().post("PullDownToRefresh");
                }
                mTitleText.setText(REFRESH_HEADER_PULLDOWN);
